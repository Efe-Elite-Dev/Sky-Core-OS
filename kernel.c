/**
 * ==============================================================================
 * WIND OS / SKY CORE OS v1.5 - Vortex Kernel (Temizlenmiş Sürüm)
 * ==============================================================================
...
static const uint8_t FONT5[128][7] = {
    ...
    ['A'] = {0x0E,0x11,0x11,0x1F,0x11,0x11,011},
    ...
    ['h'] = {0x10,0x10,0x1E,0x11,0x11,0x11,011},
...
static void draw_terminal_window(void)
{
    ...
    draw_str(264, 260, "Yuklu uygulamalar:", 0xFFAAAAAA, 1);
...
static void render_desktop(void)
{
    ...
    draw_str(50, 132, "21C  Bulutlu ve Firtina", 0xFFF5F5F5, 1);
...
static void handle_mouse(void)
{
    ...
    if (!(mb[0] & 0x08)) return; /* gecersiz paket */
